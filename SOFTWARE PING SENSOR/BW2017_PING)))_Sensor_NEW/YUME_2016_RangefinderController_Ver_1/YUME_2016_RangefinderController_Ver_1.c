...
//            
            ...
            delay_ms(3);
            Ping_Scan(PING_REAR_LEFT);Send_UART(distance[PING_REAR_LEFT]);//if(distance[PING_REAR_LEFT]!=0){Send_UART(distance[PING_REAR_LEFT]);}
            delay_ms(3);
            Ping_Scan(PING_REAR_RIGHT);Send_UART(distance[PING_REAR_RIGHT]);//if(distance[PING_REAR_RIGHT]!=0){Send_UART(distance[PING_REAR_RIGHT]);}
//            delay_ms(3);
//            SHARP_SCAN(SHARP_L);printf("SHARP: %d \t",SHARP_DIST[SHARP_L]);
//            delay_ms(100);
//            SHARP_SCAN(SHARP_FRONT_R);printf("SHARP: %d \r",SHARP_DIST[SHARP_FRONT_R]);
//            delay_ms(100);
            
//              Ping_Scan(PING_LEFT);Send_UART(distance[PING_LEFT]);//printf("HCR04: %d \r",distance[PING_LEFT]);
//              Ping_Scan(PING_RIGHT);Send_UART(distance[PING_RIGHT]);
...
void Ping_Scan(int CHANNEL)
{
    ...
    switch(CHANNEL)
    {
        case 0: 
                {
//                    DDRB.5=1;PORTB.5=1;delay_us(5);PORTB.5=0;
//                    DDRB.5=0;delay_us(4);               
//        
//                    while(PINB.5==1 && flag==0){};
//                    while(PINB.5==0 && flag==0){}; TIM1_ON; TIM1_RESET;
//                    while(PINB.5==1 && flag==0){}; TIM1_OFF;  
...
//                    while(PINB.2==0 && flag==0){}; TIM1_ON; TIM1_RESET;
//                    while(PINB.2==1 && flag==0){}; TIM1_OFF;  
        
                    while(PINB.4==1 && flag==0){};
                    while(PINB.4==0 && flag==0){}; TIM1_ON; TIM1_RESET;
                    while(PINB.4==1 && flag==0){}; TIM1_OFF;  
...
//                    while(PINB.0==1 && flag==0){}; TIM1_OFF; 
                    ...
                    while(PINB.3==0 && flag==0){}; TIM1_ON; TIM1_RESET;
                    while(PINB.3==1 && flag==0){}; TIM1_OFF; 
        ...
        case 0:
                {
                     ...
                     SHARP_DIST[SHARP_FRONT_R]= (SHARP_TEMP[0]+SHARP_TEMP[1]+SHARP_TEMP[2]+SHARP_TEMP[3]+SHARP_TEMP[4])/4;  // C1
//                     ADC_Value = read_adc(1);
//                     SHARP_Vo  = (float)ADC_Value/51;   
...
//                     }
//                     
//                     SHARP_DIST[SHARP_L]= (SHARP_TEMP[0]+SHARP_TEMP[1]+SHARP_TEMP[2]+SHARP_TEMP[3]+SHARP_TEMP[4])/4;
//                     
//                     ADC_Value = read_adc(2);
//                     SHARP_Vo  = (float)ADC_Value/51;    
//                     SHARP_DIST[SHARP_RIGHT]= (float)((1/((0.0821*SHARP_Vo)-0.0042)-0.42)); 
...
//                     }
//                     
//                     SHARP_DIST[SHARP_R]= (SHARP_TEMP[0]+SHARP_TEMP[1]+SHARP_TEMP[2]+SHARP_TEMP[3]+SHARP_TEMP[4])/4;
//                     ADC_Value = read_adc(2);
//                     SHARP_Vo  = (float)ADC_Value/51;    
//                     SHARP_DIST[SHARP_FRONT_R]= (float)((1/((0.0821*SHARP_Vo)-0.0042)-0.42)); 
                }break;              
    }
