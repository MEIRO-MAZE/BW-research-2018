...
//            Ping_Scan(PING_FRONT);Send_UART(distance[PING_FRONT]);
            ...
            SHARP_SCAN(SHARP_REAR_R); Send_UART(SHARP_DIST[SHARP_REAR_R]);
            delay_ms(3);          
            SHARP_SCAN(SHARP_REAR_L); Send_UART(SHARP_DIST[SHARP_REAR_L]);
            delay_ms(3);
        ...
        case 2:
                {
                     ...
                     SHARP_DIST[SHARP_REAR_L]= (SHARP_TEMP[0]+SHARP_TEMP[1]+SHARP_TEMP[2]+SHARP_TEMP[3]+SHARP_TEMP[4])/4;
        ...
        case 3:
                {
                     ...
                     SHARP_DIST[SHARP_REAR_R]= (SHARP_TEMP[0]+SHARP_TEMP[1]+SHARP_TEMP[2]+SHARP_TEMP[3]+SHARP_TEMP[4])/4;
//                     ADC_Value = read_adc(2);
//                     SHARP_Vo  = (float)ADC_Value/51;    
//                     SHARP_DIST[SHARP_RIGHT]= (float)((1/((0.0821*SHARP_Vo)-0.0042)-0.42)); 
                }break;              
